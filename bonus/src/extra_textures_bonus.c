...
/*   Updated: 2023/03/02 01:08:35 by ewurstei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_extra_textures(t_vault *data)
{
	...
	data->tex->tex_tribute = mlx_load_xpm42("./assets/tex/dungeon_tribute.xpm42");
	data->tex->tex_marc = mlx_load_xpm42("./assets/tex/dungeon_marc.xpm42");
	data->tex->tex_armada = mlx_load_xpm42("./assets/tex/dungeon_armada.xpm42");
	data->tex->tex_torrent = mlx_load_xpm42("./assets/tex/dungeon_torrent.xpm42");
	check_extra_textures(data);
}
