...
/*   Updated: 2023/03/02 08:08:16 by maison           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_extra_textures(t_vault *data)
{
	...
	data->tex->tex_tribute = mlx_load_xpm42("./assets/tex/dungeon_trib.xpm42");
	...
	data->tex->tex_torrent = mlx_load_xpm42("./assets/tex/dungeon_tor.xpm42");
	check_extra_textures(data);
}
